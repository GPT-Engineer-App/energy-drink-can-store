    ...
    <Container maxW="container.xl" p={0}>
      ...
      <Flex direction={{ base: "column", md: "row" }} align="center" justify="center" wrap="wrap" minH="100vh" px={8} py={20} bg={useColorModeValue("gray.50", "gray.800")}>
        <Box flex="1" maxW={{ md: "50%" }}>
          ...
          <Image borderRadius="lg" src="https://images.unsplash.com/photo-1542444459-5f6b2a6d6e60?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxlbmVyZ3klMjBkcmluayUyMGNhbnxlbnwwfHx8fDE3MDk4MTQ0MTJ8MA&ixlib=rb-4.0.3&q=80&w=1080" alt="Energy Drink Can" mb={10} boxShadow="2xl" display={{ base: "none", md: "block" }} />
          <Image borderRadius="lg" src="https://images.unsplash.com/photo-1603201665146-40f1f7b5af0e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxlbmVyZ3klMjBkcmluayUyMGNhbnxlbnwwfHx8fDE3MDk4MTQ0MTJ8MA&ixlib=rb-4.0.3&q=80&w=1080" alt="Energy Drink Can" mb={10} boxShadow="2xl" display={{ base: "none", md: "block" }} />
        </Box>
